...
$pth['folder']['toolbars'] = $pth['folder']['base'] . 'plugins/tinymce/inits/';
...
if (preg_match('/adm.php/i', $_SERVER['SCRIPT_NAME']))
    die('Access Denied');
...
// SETTINGS
    ...
    if ($f == 'settings') 
	{
		...
		if($cf['site']['allow_config'] == 'true' && $cf['site']['full_settings_menu'] == 'true')
		{
			...
			$o .= '<li><a href="' . $sn . '?file=log&amp;action=edit">' . $tx['action']['edit'] . ' ' . $tx['filetype']['log'] . ' &raquo;</a></li>' . "\n";

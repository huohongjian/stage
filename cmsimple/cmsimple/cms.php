...
define('CMSIMPLE_XH_VERSION', 'CMSimple 4.4.4'); //for compatibility CMSimple_XH
define('CMSIMPLE_XH_BUILD', 2014072101); //for compatibility CMSimple_XH
define('CMSIMPLE_XH_DATE', '2014-07-21'); //for compatibility CMSimple_XH

define('CMSIMPLE_VERSION', 'CMSimple 4.4.4');
define('CMSIMPLE_RELEASE', 2014072101);
define('CMSIMPLE_DATE', '2014-07-21');
...
{
	$subsite_folder = rtrim($subsite_folder, '/') . '/';
...
$sn = preg_replace('/([^\?]*)\?.*/', '\1', preg_replace('/index.php/i','',sv(($iis ? 'SCRIPT_NAME' : 'REQUEST_URI'))));
